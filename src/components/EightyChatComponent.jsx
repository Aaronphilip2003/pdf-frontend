...
const EightyChatComponent = () => {
  const [messages, setMessages] = useState([]);

  const API_ENDPOINT = "http://127.0.0.1:8000/query/eighty/"; // API endpoint for Eighty
    ...
    <div className="chatPage-div">
      <MainContainer>
        <ChatContainer>
          ...
          <MessageInput placeholder="Chat with Eighty....." onSend={sendMessage} />
        </ChatContainer>
      </MainContainer>
    </div>
  );
...
export default EightyChatComponent;

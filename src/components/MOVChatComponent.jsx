...
const MOVChatComponent = () => {
  const [messages, setMessages] = useState([]);

  const API_ENDPOINT = "http://127.0.0.1:8000/query/mov/";
    ...
    <div className="chatPage-div">
      <MainContainer>
        <ChatContainer>
          ...
          <MessageInput placeholder="Chat with MOV......" onSend={sendMessage} />
        </ChatContainer>
      </MainContainer>
    </div>
  );
...
export default MOVChatComponent;

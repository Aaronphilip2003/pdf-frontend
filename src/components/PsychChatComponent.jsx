...
const PsychChatComponent = () => {
  const [messages, setMessages] = useState([]);

  const API_ENDPOINT = "http://127.0.0.1:8000/query/psych/";
    ...
    <div className="chatPage-div">
      <MainContainer>
        <ChatContainer>
          ...
          {/* MessageInput for Psych */}
          <MessageInput placeholder="Chat with Psychology of Money....." onSend={sendMessage} />
        </ChatContainer>
      </MainContainer>
    </div>
  );
...
export default PsychChatComponent;
